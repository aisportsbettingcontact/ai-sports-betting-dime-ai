...
async function main() {
  ...
  for (const r of t1) console.log(`  [${r.match_id}] match_date=${r.match_date}`);
  ...
  for (const r of t2) console.log(`  [${r.match_id}] match_date=${r.match_date}`);
  ...
  for (const r of t6) console.log(`  [${r.match_id}] match_date=${r.match_date}`);
