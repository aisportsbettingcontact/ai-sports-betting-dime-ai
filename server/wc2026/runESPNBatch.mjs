 ...
 * ESPN gameIds: 760493–760504 (mapped from espn_match_id in DB)
 * 
...
const MATCHS = [
  { espn_match_id: 'wc26-r32-080', espnId: '760495', matchup: 'DR Congo @ England' },
  { espn_match_id: 'wc26-r32-081', espnId: '760493', matchup: 'Senegal @ Belgium' },
  { espn_match_id: 'wc26-r32-082', espnId: '760494', matchup: 'Bosnia @ USA' },
  { espn_match_id: 'wc26-r32-083', espnId: '760497', matchup: 'Austria @ Spain' },
  { espn_match_id: 'wc26-r32-084', espnId: '760496', matchup: 'Croatia @ Portugal' },
  { espn_match_id: 'wc26-r32-085', espnId: '760498', matchup: 'Algeria @ Switzerland' },
  { espn_match_id: 'wc26-r32-086', espnId: '760499', matchup: 'Egypt @ Australia' },
  { espn_match_id: 'wc26-r32-087', espnId: '760500', matchup: 'Cape Verde @ Argentina' },
  { espn_match_id: 'wc26-r32-088', espnId: '760501', matchup: 'Ghana @ Colombia' },
  { espn_match_id: 'wc26-r16-089', espnId: '760503', matchup: 'France @ Paraguay' },
  { espn_match_id: 'wc26-r16-090', espnId: '760502', matchup: 'Morocco @ Canada' },
  { espn_match_id: 'wc26-r16-091', espnId: '760504', matchup: 'Norway @ Brazil' },
];
...
for (let i = 0; i < MATCHS.length; i++) {
  const { espn_match_id, espnId, matchup } = MATCHS[i];
  console.log(`\n[${i+1}/12] [INPUT]  match_id=${espn_match_id} | espn_match_id=${espnId} | ${matchup}`);
  ...
  results.push({ espn_match_id, espnId, matchup, success, elapsed });
...
for (const r of results) {
  ...
  console.log(`  ${status} [${r.espn_match_id}] espnId=${r.espnId} | ${r.matchup} | ${r.elapsed}s`);
}
