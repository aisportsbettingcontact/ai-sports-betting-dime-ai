...
export default function Home() {
  ...
  useEffect(() => {
    if (!authLoading && appUser) {
      ...
      console.log(
        `[Login] [STATE] Already authenticated — redirecting to returnPath=${returnPath}`
      );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "#101014" /* brand law: flat surface, no gradients */,
      ...
      >
        ...
        <div className="flex lg:hidden flex-col items-center gap-3 mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-[12px] text-[#9A9AA8] mt-0.5">
        ...
        >
          ...
          {discordErrorMsg && (
            ...
            >
              <p
                className="uppercase tracking-widest text-[10px] text-[#6E6E78]"
          ...
          {!forgotOpen ? (
            ...
            >
              ...
              {formError && (
                <p
                  className="text-[12px] text-[#9A9AA8] text-center -mt-1"
                  role="alert"
                >
                  {formError}
                </p>
          ...
          <p className="text-center text-[11px] text-[#9A9AA8] mt-6">
            By signing in you agree to gamble responsibly. For informational
