...
export default function MarketSignals() {
  ...
  return (
    <section
      className="sec"
      id="signals"
      aria-label="Today's market signals — demo"
    >
      <div className="wrap">
          ...
          <div style={{ marginTop: "clamp(24px, 4vw, 36px)" }}>
            ...
            <div className="signals-table">
              <div className="sig-head" aria-hidden="true">
                ...
                <span>Edge</span>
                <span style={{ textAlign: "right" }}>Classification</span>
              </div>
              {rows.map(r => (
                <div
                  key={r.id}
                  className={`sig-row${r.state === "pass" ? " sig-row--pass" : ""}${r.state === "locked" ? " sig-row--locked" : ""}`}
                >
            ...
            <div className="signals-foot">
              <span className="mono">
                Sample data: the live board prices every game, every market
              </span>
              <span className="lead" aria-hidden="true" />
              <a
                href="#pricing"
                style={{
                  font: "600 15px 'Familjen Grotesk', sans-serif",
