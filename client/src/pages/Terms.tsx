      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <section className="space-y-6 text-sm leading-relaxed">
          <div>
            ...
            <p>
              By accessing or using Dime AI ("the Platform"), operated by
              Tailered Sports, Inc., you agree to be bound by these Terms of
          ...
          <div>
            ...
            <p>
              ...
              AI-powered analytical outputs including probability distributions,
              no-vig pricing, Monte Carlo simulations, and market edge analysis.
              The Platform covers multiple sports including soccer (matches),
              baseball, basketball, and hockey.
            </p>
            <p className="mt-2 font-semibold">
              The Platform does NOT provide guaranteed outcomes, financial
              advice, or wagering services. All outputs are probabilistic
              analytical tools.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>
                Your subscription renews automatically unless cancelled before
                the renewal date.
              </li>
              <li>
              ...
              <li>
                ...
                notice. Existing subscribers retain their current rate until the
                next renewal cycle after the notice period.
              </li>
              <li></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              All models, algorithms, analytical frameworks, and software
              comprising the Platform are the intellectual property of Tailered
              Sports, Inc. Your subscription grants a limited, non-transferable
              license to use Platform outputs for personal analytical purposes
              only.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              ANY ANALYTICAL OUTPUT. PAST PERFORMANCE OF OUR MODELS DOES NOT
              GUARANTEE FUTURE RESULTS.
            </p>
            <p className="mt-2">
              Our intelligence software generates probabilistic analysis based
              on historical data and statistical modeling. No output should be
              interpreted as a guarantee of any outcome or as financial advice.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              process, or accept wagers. You are solely responsible for
              compliance with all applicable laws in your jurisdiction regarding
              sports wagering.
            </p>
            <p className="mt-2 font-semibold">
            ...
            <p className="mt-2">
              ...
              Platform. By using the Platform, you represent that you meet the
          ...
          <div>
            ...
            <p>
              ...
              violate these Terms. Upon termination, your access to the Platform
              and all associated data will be revoked.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              least 14 days before taking effect. Continued use after changes
          ...
          <div>
            ...
            <p>
              For questions about these Terms, contact us through the Platform's
              support channels or at the email associated with your account.
            </p>
          </div>
        </section>
      </main>
