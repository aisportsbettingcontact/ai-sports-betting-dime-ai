...
const CDN_MONEY_BAG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663397752079/MW3FicTy7ae3qrm8dx8Lua/icon-money-bag_b9c73c5d.png";
const CDN_NBA =
      ...
      <div className="flex items-center px-3 py-2.5 gap-2">
        ...
        >
          ...
          <div className="flex flex-col" style={{ minWidth: 0 }}>
            ...
            {awayNick && (
              <span
                className="font-normal text-zinc-300 leading-tight hidden sm:block"
...
export default function BettingSplitsPage({
  ...
  const setSelectedSport = useCallback(
    (sport: "MLB" | "NHL" | "NBA") => {
      ...
      setLocation(bettingSplitsPath(sport, selectedDate));
    },
  ...
  const setSelectedDate = useCallback(
    (date: string) => {
      ...
      setLocation(bettingSplitsPath(selectedSport, date));
    },
    [selectedSport, setLocation]
  );
  useEffect(() => {
    ...
    <div className="bg-background">
      ...
      >
                  ...
                  {appUser ? (
                    <>
                      <div className="px-3 py-2.5 border-b border-border">
                        ...
                        {(() => {
                          const exp = (
                            appUser as { sessionExpiresAt?: number | null }
                          ).sessionExpiresAt;
                          if (!exp)
                            return (
                          ...
                          const daysLeft = Math.max(
                            0,
                            Math.ceil((exp - Date.now()) / 86_400_000)
                          );
                          const color =
                            daysLeft <= 3
                          ...
                          return (
                            <span
                              className={`inline-flex items-center gap-1 mt-1 px-1.5 py-0.5 rounded text-[10px] font-medium ${color}`}
                            >
                              <span
        ...
        >
          ...
          <Link
            href={bettingSplitsPath(selectedSport, selectedDate)}
            aria-current="page"
        ...
        >
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-full text-sm font-bold tracking-wide transition-all flex-shrink-0"
            style={
              selectedSport === "MLB"
                ? {
          ...
          >
            <img
              ...
              style={{
                objectFit: "contain",
                opacity: selectedSport === "MLB" ? 1 : 0.5,
                flexShrink: 0,
              }}
            />
            MLB
          ...
          >
            <img
              ...
              style={{
                objectFit: "contain",
                opacity: selectedSport === "NHL" ? 1 : 0.5,
                flexShrink: 0,
              }}
            />
            NHL
          ...
          >
            <img
              ...
              style={{
                objectFit: "contain",
                opacity: selectedSport === "NBA" ? 1 : 0.5,
                flexShrink: 0,
              }}
            />
            NBA
          ...
          {showDropdown && (
            ...
            >
              <div
                className="flex items-center justify-between px-3 py-2 border-b border-white/10 sticky top-0"
