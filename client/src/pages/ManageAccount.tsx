            ...
            <div className="space-y-1">
              ...
              {isLifetime ? (
                <span
                  ...
                  style={{ background: "#FFD700", color: "#000", letterSpacing: "0.08em" }}
                >
                  LIFETIME ACCESS
                </span>
              ) : (
                <div className="flex items-center gap-2 flex-wrap">
                  <span
                    className="inline-flex items-center px-2.5 py-1 rounded text-xs font-black tracking-wider"
                    style={{ background: "#39FF14", color: "#000", letterSpacing: "0.06em" }}
                  >
            ...
            {appUser.discordId && (
              <div className="space-y-0.5">
                ...
                <div className="flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="#738ADB" aria-hidden="true">
          ...
          <div className="w-full max-w-sm bg-card border border-border rounded-2xl p-6 space-y-4 shadow-2xl">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-2.5 rounded-lg bg-red-500/20 border border-red-500/40 text-sm font-semibold text-red-400 hover:bg-red-500/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
