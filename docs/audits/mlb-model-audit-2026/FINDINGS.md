...
| D-013 | P2 | 154 stale fg_* ledger rows (130 MISSING_DATA + 24 VOID) on 36 now-final games — B7b engine-drive failures left them ungraded | OPEN (small re-drive batch) |
