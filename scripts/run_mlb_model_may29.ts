/**
 * run_mlb_model_may29.ts
 *
 * Standalone runner: force-reruns the MLB model for 2026-05-29.
 * Bypasses tRPC auth layer — calls runMlbModelForDate directly.
 *
 * Usage:
 *   cd /home/ubuntu/ai-sports-betting
 *   npx tsx scripts/run_mlb_model_may29.ts
 *
 * [INPUT]  date=2026-05-29, forceRerun=true, targetGameIds=ALL (15 games)
 * [STEP]   1. Load DB connection via DATABASE_URL
 * [STEP]   2. Call runMlbModelForDate with forceRerun=true
 * [STEP]   3. Log full result summary with per-game breakdown
...
async function main() {
  console.log('\n════════════════════════════════════════════════════════════════');
  console.log('[INPUT]  date=' + DATE + ' | forceRerun=true | targetGameIds=ALL (15 games)');
  console.log('[STEP]   Initializing MLB model force-rerun for May 29, 2026...');
  console.log('════════════════════════════════════════════════════════════════\n');
  ...
  console.log('\n════════════════════════════════════════════════════════════════');
  console.log('[OUTPUT] MODEL RUN COMPLETE — May 29, 2026');
  console.log('════════════════════════════════════════════════════════════════');
