...
async function main() {
  ...
  const matches2026 = r2026.map((r, i) => ({ idx: i, id: r.fixture_id, year: 2026, homeTeam: r.home_team_id, awayTeam: r.away_team_id, homeScore: r.home_score, awayScore: r.away_score, city: r.city || '' }));
