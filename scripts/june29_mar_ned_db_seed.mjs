 ...
 * Seed Morocco vs Netherlands fixture + frozen book odds to DB
...
`, [FIXTURE_ID, MATCH_DATE, KICKOFF_UTC, HOME_TEAM_ID, AWAY_TEAM_ID, useVenue]);
console.log(`[VERIFY][006] Fixture upserted: ${FIXTURE_ID} | home=${HOME_TEAM_ID} away=${AWAY_TEAM_ID} venue=${useVenue}`);

// Upsert frozen book odds
console.log(`[STEP][007] Upserting frozen book odds for ${FIXTURE_ID}...`);
await conn.execute(`
...
await conn.end();
console.log('[STEP][010] DB disconnected | SEED COMPLETE | fixture=wc26-r32-076 Morocco vs Netherlands');
