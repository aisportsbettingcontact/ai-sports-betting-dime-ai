...
**North Star:** _Weekly Users with ≥1 Repeat Value Event_ — distinct eligible users who got
...
### 4a. Session / engagement — _total active screen time_
...
### 4b. Navigation — _screen time per page, where time goes_
...
### 4c. Actions — `action_performed { action_name }` — _total & unique actions_
...
### 4d. Feature lifecycle — _most-important features / friction_
...
### 4e. Value events (qualifies_active) — _the honest "active" numerator_
